...
const LIST_URL = `${BASE_URL}/pulmuone/newsroom/listPulmuone.do?menu=312`;
...
async function main(options = {}) {
  ...
  console.log('==================================================');
  console.log('풀무원 뉴스룸 브랜드뉴스(menu=312) 데이터 수집을 시작합니다.');
  console.log('==================================================');

  const scrapedBrandNews = [];
  ...
  console.log('==================================================');
  console.log(`브랜드뉴스 총 ${scrapedBrandNews.length}건 수집 완료.`);
  ...
  // Add newly scraped brand news
  for (const item of scrapedBrandNews) {
    if (item.url) {
  ...
  console.log('==================================================');
  console.log(`병합 성공!`);
  console.log(`- 새로 수집된 브랜드뉴스: ${scrapedBrandNews.length}건`);
